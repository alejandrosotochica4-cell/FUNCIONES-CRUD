Algoritmo ejercicio6ritmrticos
    Definir n, i, op, j, k Como Entero
    Definir radio, altura, volumen Como Real
    Dimension resultados[100] 
	escribir "         CALCULADORA DE CONOS"
    Escribir "¿Cuántos conos desea almacenar?: "
    Leer n
    Si n > 100 Entonces
        n <- 100
    FinSi
    i <- 1
    Repetir
        Escribir "--- MENÚ CRUD - Volumen Cono ---"
